...
public class MatchHalvesFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_match_halves_fragment2, container, false);
        ...
        starNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Navigation.findNavController(getActivity(), R.id.nav_host_fragment).navigate(R.id.action_matchHalvesFragment2_to_matchHalvesFragment3);
            }
        });
                ...
                databaseReference.child(user.getUid())
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                Navigation.findNavController(getActivity(), R.id.nav_host_fragment).navigate(R.id.action_matchHalvesFragment2_to_homeFragment2);
                            }
                        });
            }
        });

        startRight.setOnTouchListener(new MatchHalvesFragment2.MyTouchListener());
        starOption2.setOnDragListener(new MatchHalvesFragment2.MyDragListener());
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    starOption2.setOnDragListener(null);
